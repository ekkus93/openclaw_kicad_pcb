# Actionable failures for li-ion-battery-charger-circuit-gems-electronics

- Source file: **li-ion-battery-charger-circuit-gems-electronics.kicad_sch**
- Result: **fail**
- Total score: **0.00**
...
- intrinsic `routing_simplicity` = 11.28
- intrinsic `label_strategy` = 15.00
- intrinsic `spread` = 10.00
- intrinsic `power_symbols` = 10.00
- similarity `role_counts` = 4.00
- similarity `relative_positions` = 1.56
