# Actionable failures for microsd-card-in-spi-mode-with-hotswap-support

- Source file: **microsd-card-in-spi-mode-with-hotswap-support.kicad_sch**
- Result: **fail**
- Total score: **0.00**
...
- [low] `routing_simplicity` — wire stub ratio is too high. (edit: src/kicad_pcb/router.py)
